...
●	Verzija aplikacije se sastoji od major i minor broja. Aplikacije imaju verziju uglavnom u 
formatu major.minor i primer bi bio Facebook 2.1 gde je major=2 i minor=1
...
Notifikacija: Nova verzija aplikacije je dostupna za instalaciju.
	 ...
	 */
		...
		if (majorInst < majorNova) {
			System.out.println("Nova verzija aplikacije je dostupna za instalaciju.");
		} else if (majorInst == majorNova && minorInst < minorNova) {
			System.out.println("Nova verzija aplikacije je dostupna za instalaciju.");
		} else if (majorInst == majorNova && minorInst == minorNova) {
